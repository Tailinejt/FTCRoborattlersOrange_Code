...
@TeleOp(name="LolBot", group="Linear OpMode")
//@Disabled

public class Lolbot extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        meow = hardwareMap.get(Servo.class, "meow" );
        ...
        while (opModeIsActive()) {
            ...
            */
            ...
            // Servo info
            telemetry.addData("ClawServo1", ClawServo.getPosition());
            telemetry.addData("ClawServo2", ClawServo2.getPosition());
